...
public class PublishDeployWorkflowExecutionLogEnableDisableOptionLocators 
{
	...
	@FindBy(xpath = "//a[@title='Add Workflow']")
	public static WebElement addworkfloButtonString;
	...
	@FindBy(xpath = "//span[text()='Execution logs option Test']")
	public static WebElement maintainExelogTestProject_str;
	...
	@FindBy(xpath = "//div[@id='delete-project-modal']")
	public static WebElement deleteprojectmodalString;

	@FindBy(xpath = "//div[@class='loading-indicator-body']")
	public static WebElement loaderbody;
