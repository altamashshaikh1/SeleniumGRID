...
public class UserManagementTestLocators 
{
	...
	@FindBy(xpath = "//span[text()='Can manage users, roles and projects in the tenant.']")
	public static WebElement rolesCreatedString;
