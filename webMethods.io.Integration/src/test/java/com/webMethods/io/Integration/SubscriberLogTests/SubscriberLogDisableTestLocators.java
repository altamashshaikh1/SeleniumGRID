...
public class SubscriberLogDisableTestLocators
{
	...
	@FindBy(xpath = "//div[@class='messaging-header-title flex-space-between']")
	public static WebElement subscriberform;

	@FindBy(xpath = "//div[@class='modal-overlay']")
	public static WebElement modal_overlay_str;
	...
	public static WebElement subNewworkflowmodal_str;

	@FindBy(xpath = "//div[@data-testid='deleteModal']")
	public static WebElement unsavechange_str;

	@FindBy(xpath = "//button[text()='Yes']")
	public static WebElement cancelcnf;

	@FindBy(xpath = "//div[text()='You have not created any subscribers in this project.']")
	public static WebElement nosubmsg_str;
	...
	@FindBy(xpath = "//a[@title='Queue1']")
	public static WebElement Queue_1_str;
