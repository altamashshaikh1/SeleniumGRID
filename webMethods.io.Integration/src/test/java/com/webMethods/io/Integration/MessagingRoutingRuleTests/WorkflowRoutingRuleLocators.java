...
public class WorkflowRoutingRuleLocators 
{
	...
	@FindBy(xpath ="//div[text()='Could not update the subscriber. Another subscriber, Subscriber_QueueWorkflow, is already subscribed to the queue QueueForWorkflow. There can be only one subscriber for a queue.']")	
	...
	@FindBy(xpath = "//span[text()=': Rule name is not valid.']")
	public static WebElement defaultrulename;

	@FindBy(xpath = "//div[@class='modal-main-container dlt-sys-msg modal modal-fixed-footer flow-modal flow-details medium-small with-head delete-project-modal ']//h1[text()='Confirm Default invocation ?']")
	public static WebElement declarationpage; 
	...
	@FindBy(xpath="//span[text()='Select Trigger']")
	public static WebElement Triggerlabel; 
