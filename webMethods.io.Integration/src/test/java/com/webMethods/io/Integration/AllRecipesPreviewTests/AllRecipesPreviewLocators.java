...
public class AllRecipesPreviewLocators 
{
	...
	@FindBy(id = "a0")
	public static WebElement trelloAction;

	@FindBy(xpath = "//div[@id='a0']//span[@title='Settings']")
	public static WebElement trelloActionSettings;

	@FindBy(id = "activity-settings")
	public static WebElement trelloActionConfigurationModal;

	@FindBy(xpath = "//button[@class='btn btn-link btn-sm']")
	public static WebElement trelloConfigModalClose;
